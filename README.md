...
external runtime). Built on [flux.h](https://github.com/hitechcloud-vietnam/flux.h).
...
[**latest release**](https://github.com/hitechcloud-vietnam/gpuwatch/releases/latest) page.

Debian / Ubuntu:

```
curl -sSLO https://github.com/hitechcloud-vietnam/gpuwatch/releases/latest/download/gpuwatch_amd64.deb
...
```
curl -sSLO https://github.com/hitechcloud-vietnam/gpuwatch/releases/latest/download/gpuwatch.x86_64.rpm
...
```
curl -sSL https://github.com/hitechcloud-vietnam/gpuwatch/releases/latest/download/gpuwatch-linux-x86_64.tar.gz | tar xz
```
...
Older cards? [**gddr6**](https://github.com/hitechcloud-vietnam/gddr6) reads GDDR6/GDDR6X
